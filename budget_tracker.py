"""
This is my Personal Budget Tracker Application
Demonstrates: Data Structures, Data Types, and Python Basics
- Lists, Dictionaries, Tuples, Sets
- Strings, Integers, Floats, Booleans
- Functions, Loops, Conditionals, Exception Handling
"""
...
def save_data():
    ...
    try:
        with open("/home/Desktop/budget_data.json", "w") as file:
...
def load_data():
    ...
    try:
        with open("/home/budget_data.json", "r") as file:
            data = json.load(file)
        ...
        print("\n Welcome to your montly budget system.")
    except Exception as e:
